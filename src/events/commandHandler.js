...
module.exports = async (message) => {
  ...
  const embed = new MessageEmbed().setFooter(`† Shéw Developed by OZİ`).setColor(message.member.displayHexColor).setAuthor(message.member.displayName, message.author.avatarURL({ dynamic: true, size: 2048 }));
